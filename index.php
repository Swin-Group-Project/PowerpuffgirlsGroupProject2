  ...
  <?php include "./includes/header.inc" ?>
    ...
    <main id="main" class="container" tabindex="-1">
      ...
      <section class="tiles" role="navigation" aria-label="Feature tiles">
        ...
        <a class="tile tile-home tile-hover" href="index.php" aria-label="Go to Home page">
          <p class="eyebrow">Welcome</p>
          <h3>Home</h3>
        </a>

        <!-- Jobs tile (links to jobs page) -->
        <a class="tile tile-jobs tile-hover" href="jobs.php" aria-label="View open jobs">
        ...
        <a class="tile tile-apply tile-hover" href="apply.php" aria-label="Apply for a role">
